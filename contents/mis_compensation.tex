...
\todo{more introduction to the probelm and how they approached it}
\todo{add original paper reference}
...
\todo{explain why we need the optimal pdf and cannot use \ref{eq:valid_compensated_pdf}}
