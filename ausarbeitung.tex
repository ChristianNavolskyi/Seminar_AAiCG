...
\newcommand{\myname}{Christian Navolskyi, Büble of Sc.}
...
\include{contents/mis}
\include{contents/mis_compensation}
\include{contents/application_ibl}
\include{contents/application_path_guiding}
